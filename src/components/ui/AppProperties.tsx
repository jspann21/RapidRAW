...
export enum Invokes {
  ...
  GetLocalAiStatus = 'get_local_ai_status',
  DownloadLocalAiModel = 'download_local_ai_model',
  DeleteLocalAiModel = 'delete_local_ai_model',
  RunLocalAiSelfTest = 'run_local_ai_self_test',
  DownloadLocalAiRuntime = 'download_local_ai_runtime',
  DeleteLocalAiRuntime = 'delete_local_ai_runtime',
  DownloadLocalAiGenerativeAssets = 'download_local_ai_generative_assets',
  StartLocalAiRuntime = 'start_local_ai_runtime',
  StopLocalAiRuntime = 'stop_local_ai_runtime',
  RunLocalGenerativeSelfTest = 'run_local_generative_self_test',
