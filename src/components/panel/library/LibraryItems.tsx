  ...
  return (
    <div
      className={clsx(
        ...
        isDragging && 'ring-2 ring-accent opacity-70 scale-[0.98] shadow-lg',
      )}
      onClick={(e: any) => {
        e.stopPropagation();
        onImageClick(path, e);
    ...
    >
      ...
      {isSyncedToGooglePhotos && (
        <div
          className="absolute bottom-1.5 right-1.5 rounded-full bg-black/60 p-1 shadow-md backdrop-blur-xs z-30"
